...
const page = () => {
  ...
  return (
    <>
    <div className="pt-14 min-h-screen w-full bg-gradient-to-br from-slate-600 to-sky-950 p-6 md:p-10 flex flex-col gap-8 md:flex-row">
      {/* Left Chat Section */}
      <div className="w-full md:w-1/3 bg-gray-900 text-white border border-opacity-55 border-emerald-100 rounded-2xl p-6 flex flex-col justify-between shadow-xl">
        ...
        <div className="mt-6">
          <div className="flex items-center bg-gray-800 rounded-full border border-opacity-50 border-slate-400 px-4 py-2">
            <input
              type="text"
      ...
      <div className="flex-1 bg-white/50 backdrop-blur-xl rounded-2xl p-10 shadow-xl text-center flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div className="p-6 rounded-2xl shadow-lg text-left">
